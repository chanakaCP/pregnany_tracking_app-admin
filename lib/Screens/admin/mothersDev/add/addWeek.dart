...
class _AddWeekState extends State<AddWeek> {
  ...
  Widget build(BuildContext context) {
    motherWeek.week = this.widget.week;
    return StreamBuilder(
      stream: userStream,
      builder: (context, currentStream) {
        if (currentStream.hasData) {
          print("1");
          // motherWeek.month = currentStream.data["month"];
          // motherWeek.week = currentStream.data["week"];
          // motherWeek.tipDescription = currentStream.data["tipDescription"];
        } else {
          print("2");
        }
        print("3");
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              child: TextFormField(
                                initialValue: motherWeek.tipDescription,
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    this.motherWeek.tipDescription = value;
                                  });
                                },
                                validator: (value) {
                                  if (value.isEmpty) {
